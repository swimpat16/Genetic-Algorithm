...
int main()
{
    ...
    for(int i = 0; i < 5; i++)
    {
        ...
        outfile << pop_size[1] << endl;
        
        // Print mutation probability
        outfile << mut_prob[1] << endl;
        
        // Print cross probability
        outfile << cross_prob[2] << endl;
        
        // Print random seed
        outfile << "-1" << endl;
        
        // Print number of generations
        outfile << generations[1] << endl;
    ...
    for(int i = 0; i < 5; i++)
    {
        ...
        // genes, pop, mut, cross, seed, generations
        // Print Number of genes
        outfile << genes[2] << endl;
        
        // Print population size
        outfile << pop_size[i] << endl;
